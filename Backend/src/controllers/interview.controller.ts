...
export const postInterviewAnswer = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const getInterview = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const { interviewId} = req.params;
        const iv = await service.getInterviewById({ interviewId, userId });
...
export const getInterviewAnswers = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const userId = (req.user as any)?.id;
        if (!userId) return res.status(401).error({ errorCode: "unauthorized" });
...
export const uploadAnswerAudio = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const submitFeedbacks = async (req: Request, res: Response, next: NextFunction) => {
    try {
